...
Public Class savings_daily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LoanManagementSystem.savings_daily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsavings_daily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As savings_daily = New savings_daily()
        rpt.Site = Me.Site
        Return rpt
    End Function
