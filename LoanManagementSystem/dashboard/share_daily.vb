...
Public Class share_daily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LoanManagementSystem.share_daily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedshare_daily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As share_daily = New share_daily()
        rpt.Site = Me.Site
        Return rpt
    End Function
