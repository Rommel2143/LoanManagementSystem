...
Public Class collection_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LoanManagementSystem.collection_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcollection_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As collection_rpt = New collection_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
