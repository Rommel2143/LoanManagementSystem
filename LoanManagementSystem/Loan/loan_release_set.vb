...
Public Class loan_release_set
    ...
    Public Sub loadprofile(reference As String)
        Try
            ...
            con.Close()
            con.Open()
            Dim cmd As New MySqlCommand("SELECT u.account_no,u.mode,u.service_fee,u.purpose,u.insurance_fee,CONCAT(mp.lastname, ', ', mp.firstname, ' ', mp.middlename) AS fullname,u.amount,u.ammortization,u.referenceno,mp.sharecap FROM `loan_app` u
