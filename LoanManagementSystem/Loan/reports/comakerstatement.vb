...
Public Class comakerstatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LoanManagementSystem.comakerstatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcomakerstatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As comakerstatement = New comakerstatement()
        rpt.Site = Me.Site
        Return rpt
    End Function
